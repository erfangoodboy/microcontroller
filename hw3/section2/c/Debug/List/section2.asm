...
; 0000 000E       timerOverflowCounter++;
	...
	ADIW R30,1
	MOVW R4,R30
; 0000 000F       if (characterPosition < 26 ) {
	LDI  R30,LOW(26)
	LDI  R31,HIGH(26)
	CP   R10,R30
	CPC  R11,R31
	BRGE _0x4
; 0000 0010         if(timerOverflowCounter == 500 ){
	LDI  R30,LOW(500)
	LDI  R31,HIGH(500)
	CP   R30,R4
	CPC  R31,R5
	BRNE _0x5
; 0000 0011 
; 0000 0012           lcd_putchar(characters[characterPosition]);
	...
	LD   R26,X
	RCALL _lcd_putchar
; 0000 0013           characterPosition += 1;
	MOVW R30,R10
	ADIW R30,1
	MOVW R10,R30
; 0000 0014           //incress x position
; 0000 0015           xLenght=xLenght+1;
	MOVW R30,R6
	ADIW R30,1
	MOVW R6,R30
; 0000 0016 
; 0000 0017           //check need to change line
; 0000 0018           if(characterPosition==20){
	LDI  R30,LOW(20)
	LDI  R31,HIGH(20)
	CP   R30,R10
	CPC  R31,R11
...
; 0000 001B           }
; 0000 001C 
; 0000 001D           lcd_gotoxy(xLenght,yLenght);
_0x6:
	ST   -Y,R6
	MOV  R26,R8
	RCALL _lcd_gotoxy
; 0000 001E           timerOverflowCounter=0;
	CLR  R4
	CLR  R5
; 0000 001F        }
; 0000 0020       }else{
...
; 0000 0031     timerOverflowCounter=0;
	CLR  R4
	CLR  R5
; 0000 0032     characterPosition=0;
	CLR  R10
	CLR  R11
; 0000 0033 
; 0000 0034     TCCR0=0x01;
	LDI  R30,LOW(1)
	OUT  0x33,R30
...
; 0000 0036     OCR0=0x00;
	OUT  0x3C,R30
; 0000 0037     TIMSK=0x01;
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 0038 
; 0000 0039     lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 003A     #asm("sei")
	sei
